...
We can visualise the tree of cells. This plot reports the cells and, on the y-axis, their time of birth. 
```{r,  fig.height=6, fig.width=11}
nodes = forest$get_nodes()

plot_sampled_cells(nodes)
```
...
nodes_S_1_1 = forest$get_subforest_for("S_1_1")

plot_sampled_cells(nodes_S_1_1$get_nodes())
```
...
plot_sampled_cells(forest_nodes = forest_nodes) %>% 
  annotate_forest(forest)
```

The horizontal line denotes sampling times, and circles the MRCAs of
interest.
