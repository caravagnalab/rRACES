...
Some functionalities allow for a smarter sampling and more advanced visualisation.
...
We use an automatic function `bbox_sampler` to determine bounding boxes so to collect a dedired number of cells of interest.
```{r,  fig.height=4, fig.width=3}
ncells = 20
n_w = n_h = 7
