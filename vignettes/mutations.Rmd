...
Let 3e-9, 6e-9, 4e-9, and 5e-9 be the SNV passenger mutation rates of the
...
# mutation rate 1e-9 and 3e-8, respectively.
m_engine$add_mutant(mutant_name = "A",
                    passenger_rates = c("+" = 1e-9, "-" =  3e-8),
                    driver_SNVs = c(SNV("22", 10510210, "TAC", "T")),
                    driver_CNAs = c())

# add the mutant "B" characterized by two driver SNVs on chromosome 22 (no
# CNA) and two epigenetic states. Its species "B+" and "B-" have mutation
# rate 8e-7 and 5e-8, respectively.
