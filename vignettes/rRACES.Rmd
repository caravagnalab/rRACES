...
rRACES wraps the [RACES](https://github.com/albertocasagrande/RACES) simulation
...
1. a discrete tissue is first simulated, with distinct clones defined by
   ...
   in a standard stochastic birth-death process, which in rRACES is empowered
...
2. from the sampled cells, the simulated phylogenetic history of the tumour
   ...
   used to attach genomes to each simulated cells. rRACES supports standard
...
3. from the simulated phylogenetic history of the tumour it is possible to
   ...
   rRACES output include common VCF formats, as well as low-level SAM
...
A rRACES simulation follows the steps (some required, some optional) that we
