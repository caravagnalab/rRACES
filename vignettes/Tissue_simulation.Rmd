---
title: "1.Tissue simulation"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{1.Tissue simulation}
...
```{r,  fig.height=4, fig.width=3}
# Depict the tissue by using 200 bins
...
We can also get a Muller plot of the genotope evolution using 
