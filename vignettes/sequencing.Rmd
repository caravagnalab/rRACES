...
In order to simulate sequencing errors, users need specify 
...
This class model a perfect Illumina sequencer. No sequencing
...
This class sets a sequencing error rate independent from the 
base in which the error occur, from the position of the base
