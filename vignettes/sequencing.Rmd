...
### Sample Purity and Normal Cell Sequencing
...
The sequencing of a sample exclusively containing wild-type cells can 
be simulated by setting the parameter `purity` to 0.
